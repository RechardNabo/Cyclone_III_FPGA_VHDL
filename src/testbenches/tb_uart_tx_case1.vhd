...
-- Case 1: Transmit byte 0x55
entity tb_uart_tx_case1 is
end entity tb_uart_tx_case1;

architecture sim of tb_uart_tx_case1 is
...
begin
    ...
    begin
        ...
        assert tx_busy = '0' report "FAIL: tx_busy should be 0 in idle" severity error;

        -- Start transmission of 0x55
        tx_data <= x"55";
        tx_start <= '1';
        wait until rising_edge(clk);
        tx_start <= '0';
        ...
        -- Verify 8 data bits: 0x55 = 01010101, LSB first: 1,0,1,0,1,0,1,0
        for i in 0 to 7 loop
            bit_val := std_logic'(((to_integer(unsigned(x"55")) / (2**i)) mod 2));
