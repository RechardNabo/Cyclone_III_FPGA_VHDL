...
entity tb_alu_512bit is
end entity tb_alu_512bit;

architecture test of tb_alu_512bit is
    ...
    constant BIT0_SET   : std_logic_vector(511 downto 0) :=
        (1 => '1', others => '0');
    constant BIT511_SET : std_logic_vector(511 downto 0) :=
        (511 => '1', others => '0');
    constant VAL_5 : std_logic_vector(511 downto 0) :=
        (2 downto 0 => "101", others => '0');
    constant VAL_3 : std_logic_vector(511 downto 0) :=
        (1 downto 0 => "11", others => '0');
    constant VAL_8 : std_logic_vector(511 downto 0) :=
        (3 downto 0 => "1000", others => '0');
    constant VAL_A : std_logic_vector(511 downto 0) :=
        (3 downto 0 => "1010", others => '0');
    constant VAL_7 : std_logic_vector(511 downto 0) :=
        (2 downto 0 => "111", others => '0');
    constant VAL_1 : std_logic_vector(511 downto 0) :=
        (0 => '1', others => '0');
    constant VAL_2 : std_logic_vector(511 downto 0) :=
        (1 => '1', others => '0');
    constant UPPER_ONES : std_logic_vector(511 downto 0) :=
        (511 downto 256 => '1', 255 downto 0 => '0');
    constant LOWER_ONES : std_logic_vector(511 downto 0) :=
        (511 downto 256 => '0', 255 downto 0 => '1');
    constant LOW_FF : std_logic_vector(511 downto 0) :=
        (7 downto 0 => '1', others => '0');
    constant HIGH_FF00 : std_logic_vector(511 downto 0) :=
        (511 downto 8 => '1', 7 downto 0 => '0');
    constant SRL_EXP : std_logic_vector(511 downto 0) :=
        (510 => '1', others => '0');
    constant SRA_EXP : std_logic_vector(511 downto 0) :=
        (511 => '1', 510 => '1', others => '0');
    constant CMP_VAL : std_logic_vector(511 downto 0) :=
        (8 => '1', others => '0');
    constant PASS_VAL : std_logic_vector(511 downto 0) :=
        (511 downto 496 => x"DEAD", 495 downto 480 => x"BEEF",
         479 downto 464 => x"CAFE", 463 downto 448 => x"BABE",
         others => '0');

begin

    dut : entity work.alu_512bit
        port map (
            a        => a,
            b        => b,
            alu_op   => alu_op,
    ...
    begin
        ...
        -- Test 8: SRL  bit511 >> 1 = bit510
        a      <= BIT511_SET;
        alu_op <= OP_SRL;
        wait for 10 ns;
        assert result = SRL_EXP
            report "SRL test failed: expected bit510 set" severity error;

        -- Test 9: SRA  bit511 >> 1 (arith) = bit511+bit510
        a      <= BIT511_SET;
        alu_op <= OP_SRA;
        wait for 10 ns;
        assert result = SRA_EXP
            report "SRA test failed: expected bit511+bit510 set" severity error;

        -- Test 10: ROL  bit511 rotate left = bit0
        a      <= BIT511_SET;
        alu_op <= OP_ROL;
        wait for 10 ns;
        ...
        -- Test 11: ROR  bit0 rotate right = bit511
        a      <= BIT0_SET;
        alu_op <= OP_ROR;
        wait for 10 ns;
        assert result = BIT511_SET
            report "ROR test failed: expected bit511 set" severity error;
        ...
        report "All 512-bit ALU tests passed" severity note;
