-- 512-bit ALU for Cyclone III FPGA
...
architecture rtl of alu_512bit is
    ...
    signal res : std_logic_vector(511 downto 0);

begin

    process(a, b, alu_op)
        variable sum_ext : unsigned(512 downto 0);
        variable sub_ext : unsigned(512 downto 0);
    begin
        res      <= (others => '0');
        carry    <= '0';
        overflow <= '0';
        ...
        case alu_op is
            ...
            when OP_ADD =>  -- A + B
                ...
                res      <= std_logic_vector(sum_ext(511 downto 0));
                carry    <= sum_ext(512);
                overflow <= (a(511) and b(511) and (not sum_ext(511))) or
                            ((not a(511)) and (not b(511)) and sum_ext(511));

            when OP_SUB =>  -- A - B
                sub_ext := ('0' & unsigned(a)) - ('0' & unsigned(b));
                res      <= std_logic_vector(sub_ext(511 downto 0));
                carry    <= sub_ext(512);
                overflow <= (a(511) and (not b(511)) and (not sub_ext(511))) or
                            ((not a(511)) and b(511) and sub_ext(511));
            ...
            when OP_INC =>  -- A + 1
                ...
                res      <= std_logic_vector(sum_ext(511 downto 0));
                carry    <= sum_ext(512);
                overflow <= (a(511) and (not sum_ext(511)));

            when OP_DEC =>  -- A - 1
                sub_ext := ('0' & unsigned(a)) - 1;
                res      <= std_logic_vector(sub_ext(511 downto 0));
                carry    <= sub_ext(512);
                overflow <= ((not a(511)) and sub_ext(511));
