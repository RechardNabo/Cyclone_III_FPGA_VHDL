-- 64-bit ALU for Cyclone III FPGA
...
architecture rtl of alu_64bit is
...
begin
    ...
    process(a, b, alu_op)
        variable sum_ext : unsigned(64 downto 0);
        variable sub_ext : unsigned(64 downto 0);
    begin
        res      <= (others => '0');
        carry    <= '0';
        overflow <= '0';
        ...
        case alu_op is
            ...
            when OP_ADD =>  -- A + B
                ...
                res      <= std_logic_vector(sum_ext(63 downto 0));
                carry    <= sum_ext(64);
                overflow <= (a(63) and b(63) and (not sum_ext(63))) or
                            ((not a(63)) and (not b(63)) and sum_ext(63));

            when OP_SUB =>  -- A - B
                sub_ext := ('0' & unsigned(a)) - ('0' & unsigned(b));
                res      <= std_logic_vector(sub_ext(63 downto 0));
                carry    <= sub_ext(64);
                overflow <= (a(63) and (not b(63)) and (not sub_ext(63))) or
                            ((not a(63)) and b(63) and sub_ext(63));
            ...
            when OP_INC =>  -- A + 1
                ...
                res      <= std_logic_vector(sum_ext(63 downto 0));
                carry    <= sum_ext(64);
                overflow <= (a(63) and (not sum_ext(63)));

            when OP_DEC =>  -- A - 1
                sub_ext := ('0' & unsigned(a)) - 1;
                res      <= std_logic_vector(sub_ext(63 downto 0));
                carry    <= sub_ext(64);
                overflow <= ((not a(63)) and sub_ext(63));
