-- 32-bit ALU for Cyclone III FPGA
...
begin
    ...
    process(a, b, alu_op)
        ...
        variable sub_ext : unsigned(32 downto 0);
    ...
    begin
        ...
        case alu_op is
            ...
            when OP_ADD =>  -- A + B
                ...
                res      <= std_logic_vector(sum_ext(31 downto 0));
                carry    <= sum_ext(32);
                overflow <= (a(31) and b(31) and (not sum_ext(31))) or
                            ((not a(31)) and (not b(31)) and sum_ext(31));

            when OP_SUB =>  -- A - B
                sub_ext := ('0' & unsigned(a)) - ('0' & unsigned(b));
                res      <= std_logic_vector(sub_ext(31 downto 0));
                carry    <= sub_ext(32);
                overflow <= (a(31) and (not b(31)) and (not sub_ext(31))) or
                            ((not a(31)) and b(31) and sub_ext(31));
            ...
            when OP_INC =>  -- A + 1
                ...
                res      <= std_logic_vector(sum_ext(31 downto 0));
                carry    <= sum_ext(32);
                overflow <= (a(31) and (not sum_ext(31)));

            when OP_DEC =>  -- A - 1
                sub_ext := ('0' & unsigned(a)) - 1;
                res      <= std_logic_vector(sub_ext(31 downto 0));
                carry    <= sub_ext(32);
                overflow <= ((not a(31)) and sub_ext(31));

            when OP_MUL =>  -- A * B (lower 32 bits)
                prod := unsigned(a) * unsigned(b);
                res  <= std_logic_vector(prod(31 downto 0));
