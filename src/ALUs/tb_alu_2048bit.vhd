...
entity tb_alu_2048bit is
end entity tb_alu_2048bit;

architecture test of tb_alu_2048bit is
    ...
    signal a        : std_logic_vector(2047 downto 0) := (others => '0');
    signal b        : std_logic_vector(2047 downto 0) := (others => '0');
    signal alu_op   : std_logic_vector(3 downto 0) := (others => '0');
    signal result   : std_logic_vector(2047 downto 0);
    ...
    constant VAL_3 : std_logic_vector(2047 downto 0) :=
        (1 downto 0 => "11", others => '0');
    constant VAL_8 : std_logic_vector(2047 downto 0) :=
        (3 downto 0 => "1000", others => '0');
    constant VAL_A : std_logic_vector(2047 downto 0) :=
        (3 downto 0 => "1010", others => '0');
    constant VAL_7 : std_logic_vector(2047 downto 0) :=
        (2 downto 0 => "111", others => '0');
    constant VAL_1 : std_logic_vector(2047 downto 0) :=
        (0 => '1', others => '0');
    constant VAL_2 : std_logic_vector(2047 downto 0) :=
        (1 => '1', others => '0');
    constant UPPER_ONES : std_logic_vector(2047 downto 0) :=
        (2047 downto 1024 => '1', 1023 downto 0 => '0');
    constant LOWER_ONES : std_logic_vector(2047 downto 0) :=
        (2047 downto 1024 => '0', 1023 downto 0 => '1');
    constant LOW_FF : std_logic_vector(2047 downto 0) :=
        (7 downto 0 => '1', others => '0');
    constant HIGH_FF00 : std_logic_vector(2047 downto 0) :=
        (2047 downto 8 => '1', 7 downto 0 => '0');
    constant SRL_EXP : std_logic_vector(2047 downto 0) :=
        (2046 => '1', others => '0');
    constant SRA_EXP : std_logic_vector(2047 downto 0) :=
        (2047 => '1', 2046 => '1', others => '0');
    constant CMP_VAL : std_logic_vector(2047 downto 0) :=
        (8 => '1', others => '0');
    constant PASS_VAL : std_logic_vector(2047 downto 0) :=
        (2047 downto 2032 => x"DEAD", 2031 downto 2016 => x"BEEF",
         2015 downto 2000 => x"CAFE", 1999 downto 1984 => x"BABE",
         others => '0');

begin

    dut : entity work.alu_2048bit
        port map (
            a        => a,
            b        => b,
            alu_op   => alu_op,
    ...
    begin
        ...
        -- Test 8: SRL  bit2047 >> 1 = bit2046
        a      <= BIT2047_SET;
        alu_op <= OP_SRL;
        wait for 10 ns;
        assert result = SRL_EXP
            report "SRL test failed: expected bit2046 set" severity error;

        -- Test 9: SRA  bit2047 >> 1 (arith) = bit2047+bit2046
        a      <= BIT2047_SET;
        alu_op <= OP_SRA;
        wait for 10 ns;
        assert result = SRA_EXP
            report "SRA test failed: expected bit2047+bit2046 set" severity error;

        -- Test 10: ROL  bit2047 rotate left = bit0
        a      <= BIT2047_SET;
        alu_op <= OP_ROL;
        wait for 10 ns;
        ...
        -- Test 11: ROR  bit0 rotate right = bit2047
        a      <= BIT0_SET;
        alu_op <= OP_ROR;
        wait for 10 ns;
        assert result = BIT2047_SET
            report "ROR test failed: expected bit2047 set" severity error;
        ...
        report "All 2048-bit ALU tests passed" severity note;
