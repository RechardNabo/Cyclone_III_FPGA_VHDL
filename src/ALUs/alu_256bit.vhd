-- 256-bit ALU for Cyclone III FPGA
...
end entity alu_256bit;

architecture rtl of alu_256bit is
...
begin
    ...
    process(a, b, alu_op)
        variable sum_ext : unsigned(256 downto 0);
        variable sub_ext : unsigned(256 downto 0);
    begin
        res      <= (others => '0');
        carry    <= '0';
        overflow <= '0';
        ...
        case alu_op is
            ...
            when OP_ADD =>  -- A + B
                ...
                res      <= std_logic_vector(sum_ext(255 downto 0));
                carry    <= sum_ext(256);
                overflow <= (a(255) and b(255) and (not sum_ext(255))) or
                            ((not a(255)) and (not b(255)) and sum_ext(255));

            when OP_SUB =>  -- A - B
                sub_ext := ('0' & unsigned(a)) - ('0' & unsigned(b));
                res      <= std_logic_vector(sub_ext(255 downto 0));
                carry    <= sub_ext(256);
                overflow <= (a(255) and (not b(255)) and (not sub_ext(255))) or
                            ((not a(255)) and b(255) and sub_ext(255));
            ...
            when OP_INC =>  -- A + 1
                ...
                res      <= std_logic_vector(sum_ext(255 downto 0));
                carry    <= sum_ext(256);
                overflow <= (a(255) and (not sum_ext(255)));

            when OP_DEC =>  -- A - 1
                sub_ext := ('0' & unsigned(a)) - 1;
                res      <= std_logic_vector(sub_ext(255 downto 0));
                carry    <= sub_ext(256);
                overflow <= ((not a(255)) and sub_ext(255));
