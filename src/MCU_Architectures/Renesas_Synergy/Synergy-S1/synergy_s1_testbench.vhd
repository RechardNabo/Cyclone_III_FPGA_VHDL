-- ================================================================================
-- synergy_s1_tb : Testbench for synergy_s1_interface (Cortex-M0+ ultra-low-power)
-- ================================================================================
library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;

entity synergy_s1_tb is
end entity synergy_s1_tb;

architecture sim of synergy_s1_tb is

    component synergy_s1_interface is
...
begin
    ...
    dut : synergy_s1_interface
        generic map ( GPIO_WIDTH => 16 )
        port map (
    ...
    begin
        ...
        wait for 10 ns;
        assert HRDATA = x"0000FFFF" report "S1: GPIO_DIR readback mismatch" severity error;

        -- Read GPIO_DATA back
        ahb_read(HCLK, x"40000000", HSEL, HWRITE, HREADY, HTRANS, HADDR);
        wait for 10 ns;
        assert HRDATA = x"0000AAAA" report "S1: GPIO_DATA readback mismatch" severity error;
        ...
        report "Synergy S1 testbench stimulus complete" severity note;
