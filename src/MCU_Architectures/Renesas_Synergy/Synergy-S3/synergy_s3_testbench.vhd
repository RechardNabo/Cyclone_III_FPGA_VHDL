-- ================================================================================
-- synergy_s3_tb : Testbench for synergy_s3_interface (Cortex-M0+ ultra-low-power)
-- ================================================================================
library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;

entity synergy_s3_tb is
end entity synergy_s3_tb;

architecture sim of synergy_s3_tb is

    component synergy_s3_interface is
...
begin
    ...
    begin
        ...
        wait for 10 ns;
        assert HRDATA = x"0000FFFF" report "S3: GPIO_DIR readback mismatch" severity error;

        -- Read GPIO_DATA back
        ahb_read(HCLK, x"40000000", HSEL, HWRITE, HREADY, HTRANS, HADDR);
        wait for 10 ns;
        assert HRDATA = x"0000AAAA" report "S3: GPIO_DATA readback mismatch" severity error;
        ...
        report "Synergy S3 testbench stimulus complete" severity note;
