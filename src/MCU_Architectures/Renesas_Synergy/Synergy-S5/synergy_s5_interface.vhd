...
--   [N] CAN/Ethernet/LCD/Security - Not included
--
...
architecture rtl of synergy_s5_interface is
    ...
    signal dma_ctrl      : std_logic_vector(31 downto 0) := (others => '0'); -- DMA control
...
begin
    ...
    begin
        if HRESETn = '0' then
            ...
            dma_ctrl <= (others => '0'); usb_ctrl <= (others => '0');
            ...
            if HSEL = '1' and HREADY = '1' and HWRITE = '1' then
                case reg_sel is
                    ...
                    when 12 => dma_ctrl     <= HWDATA;     -- DMA_CTRL
    ...
    process(HSEL, reg_sel, gpio_data_reg, gpio_dir_reg, timer_ctrl, timer_load,
            ...
            i2c_ctrl, i2c_data_reg, adc_ctrl, adc_data_reg, dma_ctrl,
    ...
    begin
        if HSEL = '1' then
            case reg_sel is
                ...
                when 12 => HRDATA <= dma_ctrl;
                when 13 => HRDATA <= usb_ctrl;
                when 14 => HRDATA <= usb_data_reg;
    ...
    -- DMA (simplified: assert dma_req when ctrl bit0 is set, clear on dma_done)
    dma_req <= dma_ctrl(0) and not dma_done;
    ...
    -- =========================================================================
    -- UNUSED PERIPHERAL OUTPUTS (S5 does not have CAN, Ethernet, LCD, Security)
    -- =========================================================================
    can_tx <= '0'; can_int <= '0';
