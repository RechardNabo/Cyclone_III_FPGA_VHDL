-- ================================================================================
-- synergy_s5_tb : Testbench for synergy_s5_interface (Cortex-M0+ ultra-low-power)
-- ================================================================================
library IEEE;
use IEEE.std_logic_1164.all;
use IEEE.numeric_std.all;

entity synergy_s5_tb is
end entity synergy_s5_tb;

architecture sim of synergy_s5_tb is

    component synergy_s5_interface is
...
begin
    ...
    dut : synergy_s5_interface
        ...
        port map (
            ...
            -- DMA master interface
            dma_int => dma_int, dma_m_addr => dma_m_addr,
    ...
    begin
        ...
        assert HRDATA = x"0000FFFF" report "S5: GPIO_DIR readback mismatch" severity error;
        wait for 10 ns;

        -- Read GPIO_DATA back
        ahb_read(HCLK, x"40000000", HSEL, HWRITE, HREADY, HTRANS, HADDR);
        assert HRDATA = x"0000AAAA" report "S5: GPIO_DATA readback mismatch" severity error;
        wait for 10 ns;
        ...
        report "Synergy S5 testbench stimulus complete" severity note;
